...
WHY MECHANICAL. On 2026-08-28 the owner ruled that `run_sim.sh` contains ZERO references to the
...
def main() -> int:
    ...
    print("\nMove it to the extension. The seam is EXT_ENV_FILE / EXT_ENV_PASS / EXT_MOUNTS /"
          "\nEXT_TREES / EXT_MOUNT_POINT / EXT_POLICY_JSON / EXT_STORE_REPAIR in run_sim.sh.")
    return 1
